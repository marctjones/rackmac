...
(define both
  '(("Mod-n" new-document "New (Office, Chrome new window/doc)")
    ...
    ("Mod-w" close-tab "Close tab (Chrome, Office)")
...
(define mac-only
  '(("Mod-Shift-z" redo "Redo (macOS)")
    ...
    ("Mod-Alt-Right" next-tab "Next tab (Chrome, Safari)") ("Mod-Shift-]" next-tab "Next tab (Chrome, Safari)")
    ("Mod-Shift-[" previous-tab "Previous tab")
    ("Mod-q" quit "Quit")
...
(define windows-only
  '(("Ctrl-y" redo "Redo (Office)") ("Ctrl-Shift-z" redo "Redo")
    ...
    ("Ctrl-F4" close-tab "Close document (Office)")
    ("Ctrl-PageDown" next-tab "Next tab (Chrome)") ("Ctrl-PageUp" previous-tab "Previous tab")
